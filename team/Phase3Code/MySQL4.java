 ...
 */
public class MySQL4 extends AbstractVerticle {
    ...
    private static final String SQL_DNS_4 = "jdbc:mysql://localhost:3306/team";
    ...
    private static final String SQL_DNS_9 = "jdbc:mysql://ec2-54-86-230-117.compute-1.amazonaws.com:3306/team";
    ...
    public void start() {
        ...
        try {
            ...
            //======================================================================
            self = conns.get(3); //change number here!!!!!
            //======================================================================
